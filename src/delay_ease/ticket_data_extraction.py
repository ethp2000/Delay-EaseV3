...
def get_data_path(filename):
    ...
    elif 'test' in filename.lower() or filename.startswith('eticket_test') or filename.startswith('ticket_test'):
...
def extract_ticket_details(image_path: str) -> dict:
    ...
    if "error" in validated_data:
        return {"error": f"photo unclear: {validated_data['error']} please upload clearer photo"}
